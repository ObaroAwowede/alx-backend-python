# Generated by Django 4.2.7 on 2025-09-24 14:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=215)),
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['sender_id'], name='chats_messa_sender__037cd6_idx'), models.Index(fields=['conversation'], name='chats_messa_convers_93703a_idx'), models.Index(fields=['sent_at'], name='chats_messa_sent_at_6f1b88_idx')],
            },
        ),
        migrations.AddIndex(
